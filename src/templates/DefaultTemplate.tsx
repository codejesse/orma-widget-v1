...
const DefaultTemplate: React.FC<DefaultTemplateProps> = ({
  ...
  return (
    <div className="w-80 bg-white rounded-lg shadow-xl overflow-hidden">
      {/* Header */}
      <div className="px-4 py-3 flex justify-between items-center" style={{ backgroundColor: primaryColor }}>
      ...
      <div className="p-4">
        {step === 'rating' && (
          <div className="text-center">
            <p className="text-gray-700 mb-4">How would you rate your experience?</p>
            <div className="flex justify-center space-x-2 my-4">
              {[1, 2, 3, 4, 5].map((value) => (
                <button 
                  key={value}
                  onClick={() => handleRatingSelect(value)}
                  className={`text-2xl transition-colors ${rating >= value ? 'text-yellow-400' : 'text-gray-300'}`}
                >
                  ★
                </button>
              ))}
        ...
        {step === 'success' && (
          <div className="text-center py-4">
            ...
            <p className="text-gray-700 mb-4">Thank you for your feedback! We really appreciate it.</p>
            <button
              onClick={resetWidget}

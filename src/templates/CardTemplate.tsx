    ...
    return (
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M18 10c0 4.418-3.582 8-8 8s-8-3.582-8-8 3.582-8 8-8 8 3.582 8 8zm-8-3a1 1 0 00-1 1v2a1 1 0 102 0V8a1 1 0 00-1-1zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
        </svg>
        Feedback
      </button>
    );
  ...
  return (
    <div className="w-96 bg-white rounded-xl shadow-2xl overflow-hidden">
      ...
      <div className="p-6">
        {step === 'rating' && (
          <div>
            <p className="text-gray-700 font-medium mb-4 text-center">How would you rate your experience with us?</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <select
                ...
                style={{ outline: `2px solid ${primaryColor}`, outlineOffset: '2px' }}
                required
              >
        ...
        {step === 'success' && (
          <div className="text-center py-6">
            ...
            <h4 className="text-xl font-semibold mb-2" style={{ color: primaryColor }}>Feedback Received</h4>
            <p className="text-gray-600 mb-6">Thank you for taking the time to share your thoughts with us!</p>
            <button
              onClick={resetWidget}
